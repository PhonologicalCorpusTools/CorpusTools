...
[![Build Status](https://travis-ci.org/PhonologicalCorpusTools/CorpusTools.svg?branch=master)](https://travis-ci.org/PhonologicalCorpusTools/CorpusTools) [![Coverage Status](https://coveralls.io/repos/kchall/CorpusTools/badge.svg)](https://coveralls.io/r/kchall/CorpusTools) [![Documentation Status](https://readthedocs.org/projects/corpustools/badge/?version=latest)](https://readthedocs.org/projects/corpustools/?badge=latest)
