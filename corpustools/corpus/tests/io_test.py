...
class CustomCorpusTextTest(unittest.TestCase):
    ...
    def test_load_spelling(self):
        raise(NotImplementedError)
        c = load_corpus_text('test',self.spelling_path,' ',string_type='spelling')
    ...
    def test_load_transcription(self):
        ...
        c = load_corpus_text('test',self.transcription_path,' ',string_type='transcription',trans_delimiter='.')
