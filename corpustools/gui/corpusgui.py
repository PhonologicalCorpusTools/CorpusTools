...
class EditFeatureSystemWindow(object):
    def __init__(self,corpus):
        ...
        feature_menu = OptionMenu(self.top,#parent
        ...
        button_frame = Frame(self.top)
        add_segment_button = Button(button_frame, text='Add segment', command=self.add_segment)
        add_segment_button.grid()
        add_segment_button = Button(button_frame, text='Edit segment', command=self.edit_segment)
        add_segment_button.grid()
        add_feature_button = Button(button_frame, text='Add feature', command=self.add_feature)
    ...
    def change_feature_system(self, event = None):
        ...
        for seg in self.feature_matrix.get_segments():
            self.feature_chart.insert(END,[seg] + [ self.feature_matrix[seg][feat]
                                for feat in self.feature_matrix.get_feature_list()])
