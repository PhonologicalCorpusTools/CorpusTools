...
<http://phonologicalcorpustools.github.io/CorpusTools/>`_. PCT is intended to be an
...
Python (Windows, Mac, Linux). All code is available on the `GitHub repository
<https://github.com/PhonologicalCorpusTools/CorpusTools/>`_; the details for
