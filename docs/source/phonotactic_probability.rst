...
.. math:: \textnormal{PhonProb}_{\textnormal{tokens}} & = [\frac{log(22) + log(107)}{log(22) + log(107) + log(3) + log(57)}\\
& \qquad + \frac{log(22)}{log(22) + log(107) + log(3) + log(57)} + \frac{log(22) + log(3)}{log(22) + log(107) + log(3)}] / 3\\
& = 0.43795
