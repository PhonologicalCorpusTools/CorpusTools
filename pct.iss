...
Source: "dist\{#MyDistName}-{#MyAppVersion}.{#MyPlatform}\platforms\*"; DestDir: "{app}\platforms"; Flags: ignoreversion; Check: Is64BitInstallMode
Source: "dist\*.dll"; DestDir: "{app}"; Flags: ignoreversion; Check: Is64BitInstallMode

[Dirs]
Name: "{app}\appdata\updates\ready"  
Name: "{app}\appdata\updates\downloads"
