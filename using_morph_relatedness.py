...
morph_relatedness.morph_relatedness_word('iphod', 'string_similarity', 'spelling', 'type', 'dog', 0)
morph_relatedness.morph_relatedness_word('iphod', 'string_similarity', 'transcription', 'type', 'dog', 0)
